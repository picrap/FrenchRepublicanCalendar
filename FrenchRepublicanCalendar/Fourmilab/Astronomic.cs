...
namespace FrenchRepublicanCalendar.Fourmilab
{
    ...
    public static class Astronomic
    {
        ...
        */
        ...
        public static double astor(double a)
        {
        ...
        public static double fixangr(double a)
        {
        ...
        public static double[] jhms(double j)
        {
            double ij;
        ...
        public static double[] ecliptoeq(double jd, double Lambda, double Beta)
        {
            double eps, Ra, Dec;
        ...
        */
        ...
        public static double[][] JDE0tab2000 = new double[][]
        {
